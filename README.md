...
- Проверка работы кнопки 'Начать сотрудничество' (c PageObjects)
- Проверка работы страницы программы сервисного обслуживания (c PageObjects)
- Проверка наличия Title на странице (работоспособности сайта)
- Проверка наличия ошибок в консоли

## :point_up_2: Сборка в Jenkins
### <a target="_blank" href="https://jenkins.autotests.cloud/job/Zoloft-USSC-tests/">Сборка в Jenkins</a>
<p align="center">
